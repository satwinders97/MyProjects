...
namespace QuaranteamProject {
    public class PiranahSprite : ISprite {
        public Vector2 Position {
            get => context.Position;
            set => context.Position = value;
        }
        public bool IsMasked { get; set; }
        private Piranah context;
        ...
        public PiranahSprite(int rows, int columns, int totalFrames, int startingFrame, bool isAnimated, Piranah g) {
            rowCnt = rows;
            colCnt = columns;
